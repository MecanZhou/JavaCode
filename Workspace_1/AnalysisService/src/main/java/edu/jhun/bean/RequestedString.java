...
public class RequestedString {
	...
	public String toString() {
		...
		return "方案名:"+caseName+"运行次数："+federationId+"  MemberId:"+MemberId+"  startStep:"+startStep+"  endStep:"+endStep;
	}
